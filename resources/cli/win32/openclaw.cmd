...
if /i "%1"=="update" (
    echo openclaw is managed by Claw OS ^(bundled version^).
    echo.
    echo To update openclaw, update Claw OS:
    echo   Open Claw OS ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=Claw OS
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\Claw OS.exe" "%OPENCLAW_ENTRY%" %*
)
